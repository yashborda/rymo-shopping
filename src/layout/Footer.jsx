          ...
          <div className="row container mx-auto pt-5 p-0">
            <div className="footer-col col-lg-3 col-md-6">
              ...
              <p className="pt-4">
                ...
                Officiis quas eum laborum sequi, facilis ullam consequuntur
                iusto dicta culpa nobis
              </p>
            </div>
            <div className="footer-col col-lg-3 col-md-6">
              ...
              <div className="row insta-img">
                <NavLink to="#" className="w-25 h-100">
                  <img
                    ...
                    src={require(`../assets/img/insta/1.jpg`)}
                    alt="insta1"
                  />
                </NavLink>
                <NavLink to="#" className="w-25 h-100">
                  <img
                    className="img-fluid mb-3"
                    src={require(`../assets/img/insta/2.jpg`)}
                    alt="insta2"
                  />
                </NavLink>
                <NavLink to="#" className="w-25 h-100">
                  <img
                    className="img-fluid mb-3"
                    src={require(`../assets/img/insta/3.jpg`)}
                    alt="insta3"
                  />
                </NavLink>
                <NavLink to="#" className="w-25 h-100">
                  <img
                    className="img-fluid mb-3"
                    src={require(`../assets/img/insta/4.jpg`)}
                    alt="insta4"
                  />
                </NavLink>
                <NavLink to="#" className="w-25 h-100">
                  <img
                    className="img-fluid mb-3"
                    src={require(`../assets/img/insta/5.jpg`)}
                    alt="insta5"
                  />
                </NavLink>
                <NavLink to="#" className="w-25 h-100">
                  <img
                    className="img-fluid mb-3"
                    src={require(`../assets/img/insta/6.jpg`)}
                    alt="insta6"
                  />
                </NavLink>
              </div>
